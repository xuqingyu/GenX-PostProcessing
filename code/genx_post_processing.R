...
source('./code/level_1_compiling/compile_capacity_value.R') #Done
source('./code/level_1_compiling/compile_transmission.R') #Done
# source('./code/level_1_compiling/compile_transmission_congestion_revenue.R') # Currently not supported, missing file
# source('./code/level_1_compiling/compile_lse_transmission_loss_payment.R') # Currently not supported, missing file
...
# source('./code/level_1_compiling/compile_carbon_cap_loadbased.R') # Currently not supported
...
# source('./code/level_1_compiling/compile_carbon_tax_cost_n_revenue.R') # Currently not supported
...
# source('./code/level_1_compiling/compile_energy_lse_payment.R') # Currently not supported, missing file
# source('./code/level_1_compiling/compile_capacity_lse_payment.R') # Currently not supported, missing file
# source('./code/level_1_compiling/compile_capacity_trans_revenue.R') # Currently not supported, missing file
# source('./code/level_1_compiling/compile_renewable_energy_lse_payment.R')

# Level 2: Result Calculation ----
# source('./code/level_2_calculation/stitch_lse_payment_wo_transmission_allocation.R') # Currently not supported, missing file
# source('./code/level_2_calculation/transmission_congestion_n_cost_for_allocation.R') # Currently not supported, missing file
# source('./code/level_2_calculation/transmission_cost_allocation.R') # Currently not supported, missing file
